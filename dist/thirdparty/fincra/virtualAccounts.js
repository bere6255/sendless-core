...
exports.default = ({ firstName, lastName, email, bvn }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const fincraRes = yield fincra_1.default.post("/profile/virtual-accounts/requests", payload);
