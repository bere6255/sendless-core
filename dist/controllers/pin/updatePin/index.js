...
const updatePing_1 = __importDefault(require("../../../services/pin/updatePing"));
...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { status, statusCode, data, message } = yield (0, updatePing_1.default)({ newPin: value.pin, token: value.token, user });
