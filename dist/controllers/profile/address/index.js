...
const address_1 = __importDefault(require("../../../services/profile/address"));
...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { status, statusCode, data, message } = yield (0, address_1.default)(Object.assign(Object.assign({}, value), { user: req.user }));
