...
export default ({name}: changePassWord)=>`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container">
      ...
      <p>This is a confirmation that your <strong>Tencoin</strong> account password was changed on <strong>${date.format(new Date, 'YYYY/MM/DD HH:mm:ss')}</strong>.</p>
